...
\section{Problem}
The Problem that was faced in this project, was to compare different models to predict the demand of bicycles in the great city of Washington, D.C. The demand of bicycles depend on different temporal and meteorological parameters observed the past 3 years.
